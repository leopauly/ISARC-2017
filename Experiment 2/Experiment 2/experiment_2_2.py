...
y_1_test = numpy.array([(0) for i in range(0, 30000)]);
y_2_test = numpy.array([(1) for i in range(30000, 60000)]);
...
json_file = open('Network_2.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)

# load weights into new model
loaded_model.load_weights("Network_2.h5")
...
# Evaluated on images taken from same dataset but not used for training or validation
scores_c = LeedsNet.evaluate(X_test[30000:60000], y_test[30000:60000], verbose=0)
...
# Evaluated on images taken from same dataset but not used for training or validation
scores_b = LeedsNet.evaluate(X_test[0:30000], y_test[0:30000], verbose=0)
temp = (1 - scores_b[1])
