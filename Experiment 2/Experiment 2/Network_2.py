...
vgg = Sequential()
vgg.add(Convolution2D(48, 4, 4, input_shape=input_shape, border_mode='valid'))
vgg.add(Activation('relu'))
vgg.add(MaxPooling2D((2, 2), strides=(2, 2), border_mode='valid'))

vgg.add(Convolution2D(48, 5, 5, border_mode='valid'))
vgg.add(Activation('relu'))
vgg.add(MaxPooling2D((2, 2), strides=(2, 2), border_mode='valid'))

vgg.add(Convolution2D(48, 3, 3, border_mode='valid'))
vgg.add(Activation('relu'))
vgg.add(MaxPooling2D((2, 2), strides=(2, 2), border_mode='valid'))

vgg.add(Convolution2D(48, 4, 4, border_mode='valid'))
vgg.add(Activation('relu'))
vgg.add(Convolution2D(48, 4, 4, border_mode='same'))
vgg.add(Activation('relu'))
vgg.add(MaxPooling2D((2, 2), strides=(2, 2), border_mode='valid'))
...
LeedsNet.save_weights("Network_2.h5")
